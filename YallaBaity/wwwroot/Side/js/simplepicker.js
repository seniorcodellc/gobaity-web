var SimplePicker = (function (e) {
    ...
    "0DyV": function (e, t, i) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
            ...
            (t.months = [language("january"), language("february"), language("march"), language("april"), language("may"), language("june"), language("july"), language("august"), language("september"), language("october"), language("november"), language("december")]),
            (t.days = [language("sunday"), language("monday"), language("tuesday"), language("wednesday"), language("thursday"), language("friday"), language("saturday")]),
            (t.scrapeMonth = r),
